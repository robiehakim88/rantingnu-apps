...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/letters/pdf', [LetterController::class, 'generatePDF'])->name('letters.pdf');
    ...
    Route::get('/finances/{id}/print-receipt', [FinanceController::class, 'printReceipt'])->name('finances.print_receipt');
    ...
    Route::get('/finances/report/annual', [FinanceController::class, 'reportAnnual'])
        ->name('finances.report.annual'); // Laporan Tahunan
        
        

    // Filter Transaksi Berdasarkan Tahun dan Bulan
    Route::get('/finances/filter', [FinanceController::class, 'filterByYearMonth'])
        ->name('finances.filter');
    ...
    Route::get('/places/pdf', [PlaceController::class, 'generatePDF'])->name('places.pdf');

    // Rute untuk anak yatim
    ...
    Route::get('/budgets/export_pdf/{year}', [BudgetController::class, 'exportPdf'])->name('budgets.export_pdf');
    
    Route::get('/member/{id}/certificate', [MemberRoleController::class, 'generateCertificate'])->name('member.certificate');

    
    Route::resource('member-roles', MemberRoleController::class)->except(['show']);
    
    
    
    
    // Route untuk halaman daftar imam taraweh
    Route::resource('imams', ImamController::class)->except(['show']); // Nonaktifkan show() jika tidak digunakan

// Route untuk mencetak PDF
    Route::get('/imams/pdf', [ImamController::class, 'generatePDF'])->name('imams.pdf');
